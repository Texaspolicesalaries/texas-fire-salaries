...
(function () {
    ...
    container.innerHTML =
      group('Location',
        ...
        '<div class="filter-row">' +
          '<div class="field"><label for="f-zip">Near ZIP</label><input id="f-zip" data-fkey="zip" inputmode="numeric" value="' + UI.esc(state.zip) + '" placeholder="e.g. 78701"></div>' +
  ...
  function wire(container, state, onChange) {
    container.addEventListener('input', function () { read(container, state); onChange(); });
